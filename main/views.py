...
from main.models import Products, Shoppingcart, Subscription
from .documents import DocumentProduct
from .serializers import (
    ProductSerializer,
    ShoppingcartSerializers,
    ProductDocumentSerializer, SubscriberSerializer
)
...
class EmailSubscriberAPIView(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({'success': True, 'message': 'Successfully subscribed'}, status=200)
